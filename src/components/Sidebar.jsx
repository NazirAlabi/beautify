...
export const Sidebar = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute right-0 top-8 bottom-8 w-[2px] bg-gradient-to-b from-primary via-accent-lavender to-accent-gold opacity-20 rounded-full" />

      {/* Logo */}
      <div className="p-6 pb-4 flex items-center gap-3">
        <div className="bg-gradient-to-br from-primary to-accent-coral p-2.5 rounded-xl text-white shadow-lg shadow-primary/25">
          <Sparkles size={20} />
        </div>
        <div className="leading-tight">
          <span className="font-display text-2xl bg-gradient-to-r from-primary to-accent-coral bg-clip-text text-transparent">
            Beautify
          </span>
      ...
      <div className="p-3 border-t border-border/40 mx-3 mb-3">
        <button
          onClick={toggleTheme}
          className="flex items-center gap-3 w-full px-4 py-3 rounded-xl text-muted-foreground hover:text-foreground hover:bg-[var(--surface-hover)] transition-all duration-300"
        >
